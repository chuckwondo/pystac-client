...
gdf = gdf.assign(hd=ddf.hilbert_distance().compute()).sort_values("hd")
dgdf = dgpd.from_geopandas(gdf, npartitions=250, sort=False)
hulls = cast(
    pd.Series,
    dgdf.map_partitions(
...
hulls.to_json("hulls.json", orient="records", indent=4)
